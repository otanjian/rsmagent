...
(function () {
    ...
    registry["core"] = {
        "zh": {
            ...
            "new_team_chat_hint": "选择参与本次对话的智能体；未指定成员时由默认响应者接收消息，输入 @ 可指定其他成员。",
            "new_team_chat_owner": "默认响应",
            "new_team_chat_set_owner": "设为默认",
            "new_team_chat_start": "开始对话",
            "new_team_chat_min": "至少选择两个智能体，并指定其中一个为默认响应者",
            "team_chat_search": "搜索名称或职责",
            "team_chat_count": "已选 {picked} / {total}",
            "team_chat_selected_none": "尚未选择成员",
            "team_chat_no_match": "没有匹配的智能体",
            "team_chat_stale": "成员已变化，请重新选择",
            "team_chat_preparing": "正在创建对话…",
            "team_chat_remove_member": "移除成员",
            ...
            "ws_fallback_own_agent": "没有权限访问该智能体的目录，已切换到我的智能体目录",
            "ws_agent_forbidden": "没有权限打开该智能体的目录",
        ...
        "zh-Hant": {
            ...
            "new_team_chat_hint": "選擇參與本次對話的智慧體；未指定成員時由預設回應者接收訊息，輸入 @ 可指定其他成員。",
            "new_team_chat_owner": "預設回應",
            "new_team_chat_set_owner": "設為預設",
            "new_team_chat_start": "開始對話",
            "new_team_chat_min": "至少選擇兩個智慧體，並指定其中一個為預設回應者",
            "team_chat_search": "搜尋名稱或職責",
            "team_chat_count": "已選 {picked} / {total}",
            "team_chat_selected_none": "尚未選擇成員",
            "team_chat_no_match": "沒有符合的智慧體",
            "team_chat_stale": "成員已變更，請重新選擇",
            "team_chat_preparing": "正在建立對話…",
            "team_chat_remove_member": "移除成員",
            ...
            "ws_fallback_own_agent": "沒有權限存取該智慧體的目錄，已切換到我的智慧體目錄",
            "ws_agent_forbidden": "沒有權限開啟該智慧體的目錄",
        ...
        "en": {
            ...
            "new_team_chat_hint": "Pick the Agents for this conversation; the default responder takes messages that name nobody, and @ names someone else.",
            "new_team_chat_owner": "Default responder",
            "new_team_chat_set_owner": "Make default",
            "new_team_chat_start": "Start chat",
            "new_team_chat_min": "Pick at least two Agents and name one of them the default responder",
            "team_chat_search": "Search name or role",
            "team_chat_count": "{picked} of {total} selected",
            "team_chat_selected_none": "No members picked yet",
            "team_chat_no_match": "No Agent matches that",
            "team_chat_stale": "The member list changed; pick again",
            "team_chat_preparing": "Creating the conversation…",
            "team_chat_remove_member": "Remove member",
            ...
            "ws_fallback_own_agent": "No permission for that Agent's folder - showing my own Agent's folder",
            "ws_agent_forbidden": "You do not have permission to open that Agent's folder",
