const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    ctx_not_open: '当前部署未开放上下文控制',
    ctx_denied: '无权访问该会话的上下文',
    ctx_conflict: '上下文已变化，请重试',
    ctx_unavailable: '上下文服务暂不可用',
    ctx_compact_unavailable: '当前部署未开放压缩',
    ctx_compact_conflict: '压缩期间上下文发生变化，请重试',
    ...
    records_unavailable: '当前部署未开放运行历史',
    records_denied: '无权查看运行历史',
    records_error: '加载运行历史失败',
    records_scope_note: '仅显示已确认归属的运行记录',
    scheduler_notify_paused: '调度通知已暂停：无权访问或服务暂不可用',
    record_detail_preview_only: '仅预览（完整正文不可用）',
    records_refresh: '刷新',
    ...
    tasks_unavailable: '当前部署未开放调度管理',
    task_create_unavailable: '当前部署未开放任务创建',
    task_targets_unavailable: '当前部署未开放投递目标选择',
  ...
  en: {
    ...
    ctx_not_open: 'Context controls are not available in this deployment',
    ctx_denied: 'You do not have access to this conversation context',
    ctx_conflict: 'The context changed, please try again',
    ctx_unavailable: 'The context service is temporarily unavailable',
    ctx_compact_unavailable: 'Compaction is not available in this deployment',
    ctx_compact_conflict: 'The context changed during compaction, please try again',
    ...
    records_unavailable: 'Run history is not available in this deployment',
    records_denied: 'You do not have access to run history',
    records_error: 'Could not load run history',
    records_scope_note: 'Only runs with confirmed attribution are shown',
    scheduler_notify_paused: 'Scheduler notifications paused: access denied or service unavailable',
    record_detail_preview_only: 'Preview only (full body unavailable)',
    ...
    tasks_unavailable: 'Scheduling is not available in this deployment',
    task_create_unavailable: 'Task creation is not available in this deployment',
    task_targets_unavailable: 'Delivery target selection is not available in this deployment',
